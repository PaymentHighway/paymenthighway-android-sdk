...
data class MockEnvironment(override var baseURL: String) : EnvironmentInterface
...
internal class PaymentContextTest : BaseTest() {
    ...
    fun setUp() {
        ...
        paymentConfig = PaymentConfig(merchantIdTest, accountIdTest, MockEnvironment(httpUrl.url().toString()))
    }
